...
export default function ViestiVastaanottajalle({ ennakkoneuvottelu }: Readonly<HyvaksymisEsitysEnnakkoNeuvotteluProps>): ReactElement {
  ...
  return (
    <SectionContent>
      ...
      <p>
        {ennakkoneuvottelu
          ? "Lisätieto näkyy vastaanottajalle lähetetyssä sähköpostiviestissä sekä aineistolinkin takana. Kirjaa kenttään esimerkiksi sovittu ennakkoneuvottelun ajankohta."
