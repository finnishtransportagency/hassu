  ...
  const getPaattymispaiva = useCallback(
    async (value: string) => {
      try {
        ...
        setValue("jatkoPaatos1Vaihe.kuulutusVaihePaattyyPaiva", paattymispaiva);
      } catch (error) {
      ...
      <SectionContent>
        ...
        <HassuGrid cols={{ lg: 3 }}>
          <HassuDatePickerWithController
            ...
            controllerProps={{
              name: "jatkoPaatos1Vaihe.kuulutusPaiva",
            }}
          />
          <HassuDatePickerWithController
            controllerProps={{ name: "jatkoPaatos1Vaihe.kuulutusVaihePaattyyPaiva" }}
