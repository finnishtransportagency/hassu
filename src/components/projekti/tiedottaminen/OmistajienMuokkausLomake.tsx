        ...
        (async () => {
          try {
            ...
            const toBeAdded = omistajat
              ...
              .map((o) => {
                const resettableFields: (keyof OmistajaInput)[] =
                  muutOmistajat || o.osoitetiedotSaatu === false ? ["jakeluosoite", "postinumero", "paikkakunta"] : [];
                return mapOmistajaToOmistajaRow(...resettableFields)(o);
              });
