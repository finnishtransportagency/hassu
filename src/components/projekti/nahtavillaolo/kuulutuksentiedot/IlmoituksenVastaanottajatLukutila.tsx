...
export default function IlmoituksenVastaanottajat({ nahtavillaoloVaiheJulkaisu }: Props): ReactElement {
  const { t } = useTranslation("commonFI");
  const isKuntia = !!nahtavillaoloVaiheJulkaisu.ilmoituksenVastaanottajat?.kunnat;
  const isViranomaisia = !!nahtavillaoloVaiheJulkaisu.ilmoituksenVastaanottajat?.viranomaiset;
  const ilmoituksenVastaanottajat: IlmoituksenVastaanottajatType | null | undefined =
    nahtavillaoloVaiheJulkaisu.ilmoituksenVastaanottajat;
