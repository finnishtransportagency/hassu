        ...
        >
          <form style={{ display: "contents" }}>
            <DialogContent>
              ...
              <p>
                Jos nähtävilläolovaiheen kuulutukseen pitää tehdä muutoksia hyväksymisen jälkeen, tulee
                nähtävilläolovaihekuulutus avata uudelleen ja lähettää päivitetyt ilmoitukset asianosaisille.
