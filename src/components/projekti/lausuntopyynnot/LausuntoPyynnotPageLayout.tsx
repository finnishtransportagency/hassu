                ...
                <ProjektiPageLayoutContext.Consumer>
                  {({ ohjeetOpen, ohjeetOnClose }) => (
                    <OhjelistaNotification onClose={ohjeetOnClose} open={ohjeetOpen}>
                      ...
                      <li>
                        Lausuntopyynnöt tehdään käyttämällä alla olevia mallipohjia. Mallipohjat löytyvät myös toimintajärjestelmästä.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        allekirjoitus tapahtuu asianhallintajärjestelmän kautta ja lausuntopyynnöt lähetetään vastaanottajille
                        sähköpostitse.
                      </li>
                      <li>
                        Nähtävilläoloajan päätyttyä kunnille toimitetaan lausuntopyynnön täydennys, jonka yhteydessä kuntiin toimitetaan
                        myös saapuneet muistutukset. Lausuntopyynnön täydennys toimitetaan vaikka yhtään muistutusta ei oli tullut.
                      </li>
