            ...
            <div className="flex">
              <KuvaContainer className="justify-center">
                <div className="my-auto text-center">
                  <Image src="/static/vayla_alla_fi_sv_rgb.png" alt={t("vayla_logo_alt")} width="140.4" height="117" />
                </div>
                <div className="my-auto text-center">
                  <Image src="/static/ely_alla_fi_sv_rgb.png" alt={t("ely_logo_alt")} width="170.61" height="91" />
                </div>
              </KuvaContainer>
            </div>
