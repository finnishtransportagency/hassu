      ...
      <div role="navigation" className={styles["side-nav"]}>
        <SectionContent className={styles["side-nav-content"]} style={{ textAlign: "center", backgroundColor: "white" }}>
          <h3 className="vayla-subtitle" style={{ color: "rgb(0, 100, 175)" }}>
            {t(`widgetit.tutustu-vaylaan-evk`)}
          </h3>
          <p className="mt-4 mb-8">{t(`widgetit.tietoa-vaylasta-evk`)}</p>
          ...
          <ResponsiveButtonLink
            external
            primary
            href={lang == "fi" ? "https://elinvoimakeskus.fi" : "https://www.elinvoimakeskus.fi/sv/etusivu"}
            style={{ marginLeft: "auto", marginRight: "auto" }}
            target="_blank"
          >
            {t(`widgetit.elinvoimakeskus`)}
          </ResponsiveButtonLink>
        </SectionContent>
      </div>
    </TutustuSection>
