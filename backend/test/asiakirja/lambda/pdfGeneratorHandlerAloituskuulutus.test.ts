...
function testPdfFileName({
  ...
  return (
    ...
    }${vahainenMenettely ? "_vahainen" : ""}${eunRahoittama ? "_eu" : ""}${vanha ? "_vanha" : ""}${
      kieli === Kieli.RUOTSI ? "_sv" : ""
    }_${asiakirjaTyyppi.toLowerCase()}.pdf`
  );
}
...
describe("pdfGeneratorHandlerAloituskuulutus", () => {
  ...
  it("generate aloituskuulutus tie vaylavirasto", async () => {
  ...
  it("generate aloituskuulutus rata vaylavirasto", async () => {
    const event: PdfEvent = {
      asiakirjaTyyppi: AsiakirjaTyyppi.ALOITUSKUULUTUS,
      kieli: Kieli.SUOMI,
      ensisijainenKieli: Kieli.SUOMI,
  ...
  it("generate aloituskuulutus yleinen vaylavirasto", async () => {
    const event: PdfEvent = {
      asiakirjaTyyppi: AsiakirjaTyyppi.ALOITUSKUULUTUS,
      kieli: Kieli.SUOMI,
      ensisijainenKieli: Kieli.SUOMI,
  ...
  it("generate aloituskuulutus tie ely", async () => {
    const event: PdfEvent = {
      asiakirjaTyyppi: AsiakirjaTyyppi.ALOITUSKUULUTUS,
      kieli: Kieli.SUOMI,
      ensisijainenKieli: Kieli.SUOMI,
  ...
  it("generate aloituskuulutus rata ely", async () => {
    const event: PdfEvent = {
      asiakirjaTyyppi: AsiakirjaTyyppi.ALOITUSKUULUTUS,
      kieli: Kieli.SUOMI,
      ensisijainenKieli: Kieli.SUOMI,
  ...
  it("generate aloituskuulutus yleinen ely", async () => {
    const event: PdfEvent = {
      asiakirjaTyyppi: AsiakirjaTyyppi.ALOITUSKUULUTUS,
      kieli: Kieli.SUOMI,
      ensisijainenKieli: Kieli.SUOMI,
