...
describe("getZipFolder", () => {
  it("returns correct folder for 'rataan_liittyvat_toimenpiteet_tiesuunnitelmassa'", () => {
    const folder = getZipFolder("rataan_liittyvat_toimenpiteet_tiesuunnitelmassa");
