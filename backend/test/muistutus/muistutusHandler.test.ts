...
describe("apiHandler", () => {
  ...
  describe("handleEvent", () => {
    ...
    let incrementMuistutusMaaraStub: sinon.SinonStub;
    ...
    beforeEach(() => {
      ...
      incrementMuistutusMaaraStub = sinon.stub(projektiDatabase, "incrementMuistutusMaara");
      ...
      incrementMuistutusMaaraStub.resolves();
