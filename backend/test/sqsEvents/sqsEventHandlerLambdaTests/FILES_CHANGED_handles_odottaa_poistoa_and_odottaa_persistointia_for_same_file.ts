...
// sqsEventHandlerLambda handles event FILES_CHANGED by deleting old file and adding a file with the same name
export const filesChangedHandlesOdottaaPoistoaAndOdottaaTuontiaForTheSameFile = async () => {
