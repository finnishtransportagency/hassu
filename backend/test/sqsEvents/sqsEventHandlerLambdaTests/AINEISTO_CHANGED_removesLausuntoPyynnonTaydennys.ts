...
// sqsEventHandlerLambda handles event AINEISTO_CHANGED by removing lausuntoPyynnonTaydennys that are marked to be removed
export const aineistoChangedRemovesLausuntoPyynnonTaydennysFiles = async () => {
