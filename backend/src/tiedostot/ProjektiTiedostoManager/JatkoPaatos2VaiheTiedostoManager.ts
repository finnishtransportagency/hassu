...
export class JatkoPaatos2VaiheTiedostoManager extends AbstractPaatosVaiheTiedostoManager<JatkoPaatos2VaiheJulkaisu> {
  ...
  getAsianhallintaSynkronointi(
    ...
    const paths = this.projektiPaths.jatkoPaatos2Vaihe(julkaisu);
