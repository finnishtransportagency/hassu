...
import collectProjektinAineistot, { FileInfo } from "../collectProjektinAineistot";
...
> {
  ...
  } = collectProjektinAineistot(projekti, hyvaksymisEsitys, projekti.aineistoHandledAt);
