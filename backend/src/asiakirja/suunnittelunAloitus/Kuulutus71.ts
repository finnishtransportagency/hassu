...
export class Kuulutus71 extends CommonPdf<HyvaksymisPaatosVaiheKutsuAdapter> {
  ...
  private paragraphs(): PDFStructureElement[] {
    return [
      ...
      this.pluralParagraphFromKey("asiakirja.jatkopaatoksesta_ilmoittaminen.kappale1"),
      ...
      this.pluralParagraphFromKey("asiakirja.jatkopaatoksesta_ilmoittaminen.kuulutuksesta_ilmoittaminen_kappale1"),
