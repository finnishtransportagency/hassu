...
| `countKiinteistonomistajat.sh`        | Laskee kiinteistönomistajien lisäykset ja poistot CloudWatch-logeista annetulla aikavälillä | `./scripts/countKiinteistonomistajat/countKiinteistonomistajat.sh <start-time> <end-time> [env]`                                                         |
